...
from algoritmoDos import login_asesor
from algoritmoTres import mostrar_reporte_promedio


def registrar_asesores(cantidad=5, ruta_archivo="credenciales_asesores.json"):
    lista = []
    credenciales = []
...
def ejecutar_flujo_completo():
    ...
    if login_exitoso:
        print("\nLogin correcto. Ejecutando algoritmo de promedio...")
